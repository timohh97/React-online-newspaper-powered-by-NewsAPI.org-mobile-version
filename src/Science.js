...
class Science extends Component {
  ...
  componentDidMount() {
    fetch('https://newsapi.org/v2/top-headlines?country=de&category=science&apiKey=cad0f580e62d4dc8bbc84a718a0efef5')
  ...
  render() {
    ...
    return (<div><h1 id="header">Wissenschaft</h1><br></br><br></br><br></br>
