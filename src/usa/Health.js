...
class Health extends Component{
    constructor(props) {
      ...
      componentDidMount() {
        fetch('https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=cad0f580e62d4dc8bbc84a718a0efef5')
      ...
      render() {
        ...
        return (<div><h1 id="header">Health</h1><br></br><br></br><br></br>
