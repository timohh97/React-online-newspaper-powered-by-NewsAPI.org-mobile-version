...
class Entertainment extends Component {
  ...
  componentDidMount() {
    fetch('https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=cad0f580e62d4dc8bbc84a718a0efef5')
  ...
  render() {
    ...
    return (<div><h1 id="header">Entertainment</h1><br></br><br></br><br></br>
